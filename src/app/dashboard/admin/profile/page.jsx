...
import { Envelope, Person, ShoppingBag, Star } from '@gravity-ui/icons';
import { Button, Calendar, Card, Chip, Separator } from '@heroui/react';
...
const AdminProfilePage = async () => {
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto text-white px-4 py-10">
